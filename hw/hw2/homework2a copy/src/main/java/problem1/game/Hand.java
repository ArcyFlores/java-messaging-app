...
/**
 * TODO: Hand of problem1.cards is also a List, according to API
 */
public interface Hand {

  /**
   * Method that returns a Hand as a List of problem1.cards.
   *
   * @return a List
   */
  List<Card> showCards();
  ...
  /**
   * Method that adds multiple problem1.cards into our current hand.
   *
   * @param newCards the problem1.cards to add to our hand
   */
