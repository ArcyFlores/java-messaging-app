...
public class ShouShiXia implements Shou {
	...
	public static void main(String[] args) {
		Shou s = new ShouShiXia();
		s.accept(new kaShiXia(1, 0));
		s.accept(new kaShiXia(12, 3));
		s.accept(new kaShiXia(10, 2));
		s.accept(new kaShiXia(9, 2));
		s.accept(new kaShiXia(8, 1));
		System.out.println(((ShouShiXia) s).showHand());
		s.sort();
		System.out.println(((ShouShiXia) s).showHand());
	}
