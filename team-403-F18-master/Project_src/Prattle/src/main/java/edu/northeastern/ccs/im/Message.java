...
public class Message {
    ...
    /**
     * Create a new message that acknowledges a logged in user.
     *
     * @param userName the given username
     * @param text     text to insert
     * @return Instance of Message that transmits text
     */
//    public static Message makeLoginMessage(String userName, String text) {
//        return new Message(MessageType.ACKNOWLEDGE, userName, text);
//
//    }
     ...
     */
    public static Message makeHelloMessage(String text) {
